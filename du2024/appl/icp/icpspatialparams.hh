...
public:
    ...
    // added by du
	// using PcSwCurve = FluidMatrix::BrooksCoreyDefault<Scalar>;
    ...
    : ParentType(gridGeometry)
    {
        ...
        materialParams_.setSwr(0.0); // 0.2
        materialParams_.setSnr(0.0);

        // // parameters for the Brooks-Corey law
        // materialParams_.setPe(1.0e4); // 1e4
        // materialParams_.setLambda(3);
		
		// parameters for the Van Genuchten law alpha and n
		materialParams_.setVgAlpha(0.000250911);
        materialParams_.setVgn(1.873631078);
/*
                //thermalconductivity
    ...
    { return 1.0-referencePorosity_; } //edited by du
	// { return 0.0; } 
                        ...
                        const ElementSolution& elemSol) const
    {
        ...
        return permLaw_.evaluatePermeability(referencePermeability_, referencePorosity_, critPorosity_, poro);
    }
