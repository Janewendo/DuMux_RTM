...
//             // of the "ComputeFromReferencePhase" constraint solver
        ...
        for (int phaseIdx = 0; phaseIdx < ModelTraits::numPhases(); ++phaseIdx)
        {
           ...
           // printf("The value of moleFrac[CO2aqIdx] is: %.10e\n", moleFrac[CO2aqIdx]);		  
           ...
           for (int compIdx=numMajorComponents; compIdx<numComponents; ++compIdx)
           {
		    ...
		    fluidState.setMoleFraction(phase0Idx, Fe2Idx, moleFrac[Fe2totalIdx]);
		   
           } 
           // printf("The value of moleFrac[HIdx] is: %.10e\n", moleFrac[HIdx]);		   
		   // printf("The value of moleFrac[CO2aqtotalIdx] is: %.10e\n", moleFrac[CO2aqtotalIdx]);
           // printf("The value of moleFrac[CO2aqIdx]2 is: %.10e\n", moleFrac[CO2aqIdx]);
		   // printf("The value of moleFrac[Fe2totalIdx] is: %.10e\n", moleFrac[Fe2totalIdx]);
