 ...
 */
#ifndef DUMUX_PROTOIMOGOLITE_HH
#define DUMUX_PROTOIMOGOLITE_HH
...
class ProtoImogolite
: public Components::Base<Scalar, ProtoImogolite<Scalar> >
, public Components::Solid<Scalar, ProtoImogolite<Scalar> >
{
...
public:
    ...
    { return "ProtoImogolite"; }

    /*!
     * \brief The molar mass in \f$\mathrm{[kg/mol]}\f$ of Ferrohydrite.
     */
    static constexpr Scalar molarMass()
    { return 2*Al::molarMass() + 5*H2O::molarMass()+ 1*SiO2::molarMass() - 4*H::molarMass(); } // kg/mol
