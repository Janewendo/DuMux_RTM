 ...
 */
#ifndef DUMUX_HYDROXYAPATITE_HH
#define DUMUX_HYDROXYAPATITE_HH
...
: public Components::Base<Scalar, Hydroxyapatite<Scalar> >
, public Components::Solid<Scalar, Hydroxyapatite<Scalar> >
{
...
public:
    ...
    { return "Hydroxyapatite"; }

    /*!
     * \brief The molar mass in \f$\mathrm{[kg/mol]}\f$ of Ferrohydrite.
     */
    static constexpr Scalar molarMass()
    { return 5*Ca::molarMass() + OH::molarMass() + 3*HPO4::molarMass(); } // kg/mol
