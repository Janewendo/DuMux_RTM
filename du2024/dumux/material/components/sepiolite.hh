 ...
 */
#ifndef DUMUX_SEPIOLITE_HH
#define DUMUX_SEPIOLITE_HH
...
class Sepiolite
: public Components::Base<Scalar, Sepiolite<Scalar> >
, public Components::Solid<Scalar, Sepiolite<Scalar> >
{
...
public:
    ...
    { return 6*H2O::molarMass() + 4*Mg::molarMass() + 2*OH::molarMass()
	 + 6*SiO2::molarMass() + 15*O2::molarMass(); } // kg/mol
