...
public:
    ...
    static const int numComponents = 8+8; // Water, N2,  Na, h, Ca, Fe2+, O2, Mg, Al, SiO2, HPO4, K, Mn, Ti(OH)4, cl, CO2
    static const int numMajorComponents = 2; //Water, N2
	static const int numSecComponents = 7; // h_total, co3, oh,  hco3, fe2_total, fe3 ,co2(aq)_total
    ...
    static const int Fe2totalIdx =  numComponents + 5;
    ...
    static std::string componentName(int compIdx)
    {
	    ...
	    case Fe2totalIdx: return  "TotalFe";	
...
// only the molar mass of water is returned.
		...
		case Fe2totalIdx: return Fe2::molarMass();
    ...
    static Scalar charge(int compIdx)
    {
		...
		case Fe2totalIdx: return Fe2::charge();
